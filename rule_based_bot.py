...
class AlienBot:
    ...
    negative_responses = ("no", "nope", "nah", "naw", "not a chance", "n", "sorry")
    ...
    def __init__(self):
        self.alienbabble = {'describe_planet_intent': r'.*\s*your planet.*',
                            'answer_why_intent': r'(W|w)hy\sare.*',
    ...
    def greet(self):
        ...
        will_help = input(f"Hi {self.name}, I'm Butterball. I'm not from this planet. Will you help me learn about your planet? ")
    ...
    def answer_why_intent(self):
        ...
        return random.choice(responses)  # Fixed typo here
